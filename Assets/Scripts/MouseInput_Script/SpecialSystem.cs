...
public class SpecialSystem : MonoBehaviour {
    ...
    void Start() {
        ...
        //---initialize position---
        gameObject.transform.localPosition = new Vector3(-35.0f + (961.0f-Screen.width) * 0.0413f, 11.0f + (Screen.height-433.0f) * 0.0249f, 50);
    }

    public void Update() {
        //gameObject.transform.localPosition = new Vector3(-35.0f + (961.0f - Screen.width) * 0.0413f, 18, 50);
//        gameObject.transform.localPosition = new Vector3(-32.0f + (961.0f-Screen.width) * 0.0413f, 11.0f + (Screen.height-433.0f) * 0.0249f, 50);
    }
